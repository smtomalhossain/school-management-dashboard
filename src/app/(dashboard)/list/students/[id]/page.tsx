        ...
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="bg-tomSky py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
             ...
             <h1 className="text-xl font-semibold">Tomal Hossain</h1>
              <p className="text-sm text-gray-500">
                Tomal Hossain is a web developer{" "}
              </p>
             </div>
              <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
                ...
                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                  ...
                  <span className="">2025-02-01</span>
                </div>
                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                ...
                <div className="w-full md:w-1/3 lg:w-full  2xl:w-1/3 flex items-center gap-2">
                  ...
                  <span className="text-wrap">01768447320</span>
                </div>
              </div>
            </div>
          </div>
